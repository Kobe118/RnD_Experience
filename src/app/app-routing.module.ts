...
import {MealPlanCalenderComponent} from "./meal-plans/calender/meal-plan-calender.component"; // Update with the correct path to my-page.component
...
const routes: Routes = [
  ...
  { path: 'MealPlansCalender', component: MealPlanCalenderComponent },
];
